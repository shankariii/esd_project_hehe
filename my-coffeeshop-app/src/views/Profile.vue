<template>
    <div class="profile-container" style="max-width: 1200px; margin: 0 auto; padding: 2rem 1rem;">
        <!-- Page Header -->
        ...
        <div class="profile-tabs" style="margin-bottom: 2rem;">
            <button v-for="tab in tabs" :key="tab.id" @click="activeTab = tab.id"
                ...
                style="padding: 1rem 1.5rem; background: none; border: none; border-bottom: 3px solid transparent; margin-right: 1rem; font-weight: 500; cursor: pointer; position: relative;"
        ...
        <div class="tab-content"
            style="background-color: white; border-radius: 10px; padding: 2rem; box-shadow: 0 3px 10px rgba(0,0,0,0.08);">
            <!-- Current Orders Tab -->
            <div v-if="activeTab === 'current-orders'">
                <h3 style="margin-bottom: 1.5rem; color: var(--dark);">Current Orders</h3>
                ...
                <div v-else class="orders-list">
                    <div v-for="(order, index) in currentOrders" :key="order.id" class="order-card"
                        style="border: 1px solid #eee; border-radius: 8px; margin-bottom: 1.5rem; overflow: hidden;">
                        <!-- Order header -->
                        <div
                        ...
                        <div
                            ...
                            <div>
                                <button
                                    style="background: none; border: none; color: var(--primary); font-weight: 500; cursor: pointer;"
                                    @click="trackOrder(order.id)">
                                    Track Order
                                </button>
                                <button v-if="order.status === 'Processing' || order.status === 'Preparing'"
                                    style="background: none; border: none; color: var(--text-light); margin-left: 1rem; font-weight: 500; cursor: pointer;"
            ...
            <div v-if="activeTab === 'order-history'">
                <h3 style="margin-bottom: 1.5rem; color: var(--dark);">Order History</h3>
            ...
            <div v-if="activeTab === 'account-settings'">
                <h3 style="margin-bottom: 1.5rem; color: var(--dark);">Account Settings</h3>
                ...
                <form @submit.prevent="saveAccountSettings">
                    ...
                    <div style="margin-bottom: 2rem;">
                        ...
                        <div
                            ...
                            <div>
                                <label for="firstName"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 500;">First Name</label>
                                <input id="firstName" v-model="userProfile.firstName" type="text"
                                    style="width: 100%; padding: 0.8rem; border: 1px solid #ddd; border-radius: 5px; outline: none;"
                                    required>
                            </div>

                            <div>
                                <label for="lastName"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Last Name</label>
                    ...
                    <div style="margin-bottom: 2rem;">
                        ...
                        <div style="margin-bottom: 1rem;">
                            <label for="address1"
                                style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Address Line 1</label>
                        ...
                        <div style="margin-bottom: 1rem;">
                            <label for="address2"
                                style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Address Line 2
                                (Optional)</label>
                        ...
                        <div
                            ...
                            <div>
                                <label for="city"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 500;">City</label>
                            ...
                            <div>
                                <label for="state"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 500;">State/Province</label>
                            ...
                            <div>
                                <label for="zip"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 500;">ZIP/Postal
                                    Code</label>
                    ...
                    <div style="margin-bottom: 2rem;">
                        ...
                        <div style="margin-bottom: 1rem;">
                            <label for="currentPassword"
                                style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Current
                                Password</label>
                        ...
                        <div
                            ...
                            <div>
                                <label for="newPassword"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 500;">New
                                    Password</label>
                            ...
                            <div>
                                <label for="confirmPassword"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Confirm New
                                    Password</label>
                    ...
                    <div style="margin-bottom: 2rem;">
                        ...
                        <div style="margin-bottom: 1rem;">
                            <label class="checkbox-container"
                                ...
                                <span>Subscribe to newsletter for special offers and updates</span>
                            </label>
                        </div>
                        ...
                        <div>
                            <label class="checkbox-container"
                                ...
                                <input type="checkbox" v-model="userProfile.preferences.textNotifications"
                                    style="margin-right: 0.5rem; width: 18px; height: 18px;">
                                <span>Receive text notifications for order updates</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; justify-content: flex-end;">
                        <button type="submit"
                            style="background-color: var(--accent); color: var(--dark); border: none; padding: 0.8rem 2rem; border-radius: 5px; font-weight: bold; cursor: pointer;">
                            Save Changes
                        </button>
                    </div>
                </form>
