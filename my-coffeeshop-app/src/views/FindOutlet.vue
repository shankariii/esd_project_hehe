    ...
    <div class="finder-layout">
      ...
      <div class="finder-content">
        <div class="finder-controls">
          ...
          <div class="selected-outlet" v-if="selectedOutlet">
            <div class="selected-header">
              <h3>
                <a
                  :href="`https://www.google.com/maps/dir/?api=1&destination=${selectedOutlet.position.lat},${selectedOutlet.position.lng}`"
                  target="_blank"
                >
                  {{ selectedOutlet.name }}
                </a>
        ...
        <div class="outlet-list">
          <h3>All Locations</h3>
          <div v-if="isOutletsLoading">Loading outlets...</div>
          <ul v-else class="outlets">
            <li
  ...
  computed: {
    sortedOutlets() {
      if (this.userLocation && this.outlets.some(o => o.distance)) {
        return [...this.outlets].sort((a, b) => (a.distance || Infinity) - (b.distance || Infinity));
      }
  ...
  methods: {
    async fetchOutlets() {
        try {
          ...
          alert('Unable to load outlets. Please try again later.');
        } finally {
