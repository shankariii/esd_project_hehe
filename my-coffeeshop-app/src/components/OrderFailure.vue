...
export default {
  ...
  methods: {
    ...
    contactSupport() {
      ...
      window.open(
        "mailto:support@example.com?subject=Order%20Processing%20Issue%20" + this.paymentId,
        "_blank"
      );
...
.close-btn {
  ...
  font-size: 1.5rem; /* Adjust font size of the "X" */
  font-weight: bold;
  border: none;
...
.try-again-btn:hover,
.support-btn:hover {
  background-color: var(--primary); /* Slightly lighter brown on hover */
}
